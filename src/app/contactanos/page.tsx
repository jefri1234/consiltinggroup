...
const Contactenos: React.FC = () => {
  ...
  return (
    <div className="bg-gray-950 py-12 px-4 md:px-8 lg:px-24 xl:px-32 text-white h-full">
      <div className=' p-2 max-w-max m-auto h-full'>
        <section className="text-center m-auto my-5 max-w-max ">
        ...
        <section className="text-center bg-gray-900 p-6 lg:p-10 rounded-lg shadow-md mb-8 max-w-max m-auto">
        ...
        {/* Formulario */}
        <section className="bg-gray-800 p-6 lg:p-10 rounded-lg shadow-md w-full h-">
